...
exports.meshJsonToObj = meshJsonToObj;
/**
 ...
 */
function meshJsonToObj(meshJson) {
    const vertices = meshJson.vertices || [];
    const triangles = meshJson.triangles || [];
    const normals = meshJson.normals || [];
    const uvs = meshJson.uvs || [];
    const name = meshJson.name || 'Mesh';
    const lines = [];
    lines.push(`o ${name}`);
...
//# sourceMappingURL=mesh-to-obj.js.map